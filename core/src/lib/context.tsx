...
function createContext<T extends object | null>(rootComponentName: string, defaultContext?: T) {
...
function createContextScope(scopeName: string, createContextScopeDeps: CreateScope[] = []) {
  ...
  function createContext<T extends object | null>(rootComponentName: string, defaultContext?: T) {
    ...
    function Provider(props: { value: T; scope: Scope<T>; children: React.ReactNode }) {
      const { scope, children, value } = props;
    ...
    function useContext(consumerName: string, scope: Scope<T | undefined>) {
      const Context = scope?.[scopeName][index] || BaseContext;
      const context = React.useContext(Context);
      if (context) return context;
      if (defaultContext !== undefined) return defaultContext;
